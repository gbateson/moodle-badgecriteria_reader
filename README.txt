...
Moodle >= 2.x badge criteria for Reading achievements in the Moodle Reader module.
...
To complete the installation
    ...
    cp -f badges/criteria/reader/award_criteria_reader.php badges/criteria/award_criteria_reader.php
